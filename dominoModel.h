...
void jogoSingleplayerVirgem(int *Pmodo);                  // "main" do jogo singleplayer virgem.
void jogoSingleplayerCarregado();               // "main" do jogo carregado por arquivo singleplayer  (A ser implementada)
void jogoMultiplayerVirgem(int *Pmodo);                   // "main" do jogo multiplayer.
...
//FUNCOES TIPO INT
int comecarPrimeiro(tipo_Peca pecas[28], int pecasJogador[21], int pecasComp[21], int pecasCompra[14], int pecasMesa[56], int *PvalorEsquerda, int *PvalorDireita, int *PqtdPecasJogador, int *PqtdPecasComp, int **Pmodo);      // Decide qual jogador comeca primeiro de acordo com as regras de inicio de jogo.
